...
G = nx.Graph()
# Add nodes
G.add_nodes_from(actors_data.actorName, node_type='actor')
G.add_nodes_from(movies_data.title, node_type='movie')
G.add_nodes_from(genre_data.genre, node_type='genre')
